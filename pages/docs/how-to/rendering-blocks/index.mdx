...
If you haven't already, follow the [Basic Setup](https://faustjstoolkit.wpenginepowered.com/docs/basic-setup/) to get Faust.js set up.
...
![](images/Screenshot-2024-10-08-at-10.10.31 AM-1024x507.png)
...
- `renderedHTML`: It’s the HTML of the block as rendered by the [render\_block](https://developer.wordpress.org/reference/functions/render_block/) function.
...
The plugin iterates over the `block.json` types as registered within WordPress and creates WPGraphQL types and resolvers. As long as your blocks use the [register\_block\_type](https://developer.wordpress.org/reference/functions/register_block_type/) function passing a `block.json`, it will be available in the system without any extra steps.
