...
3. **[Session Management](https://nextjs.org/docs/app/building-your-application/authentication#session-management)**: Tracks the user's auth state across requests.

5. **[Authorization](https://nextjs.org/docs/app/building-your-application/authentication#authorization)**: Decides what routes and data the user can access.

This diagram shows the authentication flow using the Faust.js toolkit auth feature:

![](images/auth-redirect-flow-2048x989-3-1024x495.png)
...
If you haven't already, follow the [Basic Setup](https://faustjstoolkit.wpenginepowered.com/docs/basic-setup/) steps to get Faust.js set up.
