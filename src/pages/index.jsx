		...
		<main>
			<section className="bg-100-full bg-default-pos bg-hero-gradient">
				<div className="container-main container-max prose prose-invert md:prose-xl lg:prose-2xl prose-h1:mb-2 prose-h1:font-bold prose-h1:leading-tight container mt-0">
					<div className="mx-auto max-w-xl px-8 py-24 text-center md:max-w-2xl md:py-36 lg:max-w-3xl">
						<h1 className="bg-linear-to-br from-purple-300 to-teal-300 bg-clip-text text-transparent">
						...
						<p className="not-prose flex flex-col items-center gap-4 sm:inline-flex sm:flex-row">
							<Link
								className="not-prose text-gray-1000 group inline-flex items-center gap-1 rounded-full border border-blue-800/20 bg-linear-to-tr from-blue-600/50 from-20% to-purple-900/50 px-8 py-2 text-base leading-none tracking-tight shadow-lg backdrop-blur-lg transition duration-75 hover:border-gray-100/50 hover:bg-linear-to-tl hover:from-purple-400/80 hover:to-teal-400/80 hover:text-gray-900 hover:backdrop-blur-xl lg:py-3"
								href="/docs/"
								noDefaultStyles
							>
								Read the Docs
							...
							<Link
								className="not-prose group inline-flex items-center gap-1 rounded-full border border-gray-200/20 bg-linear-to-br from-purple-600/20 from-10% to-blue-600/20 px-8 py-2 text-base leading-none tracking-tight text-gray-200 shadow-lg backdrop-blur-lg transition duration-75 hover:border-gray-100/50 hover:bg-linear-to-tl hover:from-teal-400/80 hover:to-purple-400/80 hover:text-gray-900 hover:backdrop-blur-xl lg:py-3"
								disableExternalIcon
								href="/discord"
								noDefaultStyles
							>
			...
			<section className="bg-gray-950">
				<div className="container-main container-max prose prose-invert prose-h2:font-medium prose-h3:my-4 container px-8 py-14 lg:px-16 lg:py-24">
					<h2 className="bg-linear-to-tr from-blue-400 to-teal-300 bg-clip-text text-transparent">
