export const metadata = {
	...
	docType: "doc",
	snippet:
		"The getNextStaticProps function lets you build a static site with your WordPress data outside of the template hierarchy using Next.js file based pages",
	date: "2023-06-23",
};
