...
Faust.js is built on top of Next.js, so the build process is identical. Take a look at the Next.js [Build API](https://nextjs.org/docs/pages/building-your-application/deploying#nextjs-build-api) for info relating to how Next.js generates an optimized production build.
