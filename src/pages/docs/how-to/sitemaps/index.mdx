...
## 2. Check Your Sitemap in WordPress

Since Faust.js fetches the sitemap data from the WordPress backend, visit your sitemap at your regular WordPress site which would be your domain then the default sitemap path `/wp-sitemap.xml` to ensure it is working.

## 3. Create `sitemap.xml.js`
...
## 4. Defining Next.js Pages for Sitemaps
...
## 5. Changing the sitemap URL for other WP SEO plugins
