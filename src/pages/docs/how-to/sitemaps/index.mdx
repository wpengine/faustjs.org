...
- Set the permalink structure to: `/posts/%postname%/`

![](./images/perma-settings.png)

Then, uncheck the "Search Engine Visibility" box in your reading settings:

![](./images/reading-settings.png)

## Faust.js App

Navigate back to your Faust.js app, and in the root of the project, go to the `/pages` directory. Within the pages directory, create a file and name it `sitemap.xml.js`.
