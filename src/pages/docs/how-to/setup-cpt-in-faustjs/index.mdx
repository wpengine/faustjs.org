...
- Download these three plugins in your WordPress instance: [Advanced Custom Fields](https://www.advancedcustomfields.com/download/), [WPGraphQL for ACF](https://github.com/wp-graphql/wpgraphql-acf), [WPGraphQL IDE](https://github.com/wp-graphql/wpgraphql-ide)
