export const metadata = {
	...
	description:
		"This guide explains how to customize the Faust.js Toolbar using the toolbarNodes filter. It walks through the process of enabling the experimental toolbar feature, adding authentication, and creating a custom plugin to extend the Toolbar with new menu items and submenus.",
};
