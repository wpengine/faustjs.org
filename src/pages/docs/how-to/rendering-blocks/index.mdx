...
## 1. WPGraphQL Content Blocks Plugin
...
The `@faust/blocks` package contains a small reference list of blocks that you can use in your site.

### A. Import Block Components
