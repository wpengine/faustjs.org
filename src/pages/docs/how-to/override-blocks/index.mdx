...
![WordPress Code block](./images/core-code-block.png)
...
If you use the Faust.js [template hierarchy](/docs/how-to/template-hierarchy) feature, you can include the block fragment inside of the GraphQL query for your posts and pages.
