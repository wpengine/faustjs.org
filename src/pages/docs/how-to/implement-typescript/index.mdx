...
Once you have completed the basic setup, you now can run `npm run generate` the built in generate command that comes with faust. This will generate types and implements TS.
