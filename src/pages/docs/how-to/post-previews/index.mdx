...
In the root of your project, update your `next.config.js` file with this code:
...
### Step 4. Add Preview Data to Your WPGraphQL Queries Within Templates
...
### Step 5. Navigating to Preview Pages
